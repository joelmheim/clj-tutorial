...
* [RIP Tutorial - Clojure](https://riptutorial.com/clojure)
* [Build a simple REST API with Clojure](https://itnext.io/getting-started-with-clojure-e8f207ff8eab)
* [ClojureScript Quick start](https://clojurescript.org/guides/quick-start)
* [Getting started with Clojure CLI](http://jr0cket.co.uk/2019/07/getting-started-with-Clojure-CLI-tools.html)
* [PurelyFunctionalTV - Video tutorials](https://purelyfunctional.tv/browse/)
